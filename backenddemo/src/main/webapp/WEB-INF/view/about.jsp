				...
				<div class="row">
					<article class="col-lg-6">
						<figure class="tm-person">
							<img src="${pageContext.request.contextPath}/resources/img/about-01.jpg" alt="Image" class="img-fluid tm-person-img" />
					...
					<article class="col-lg-6">
						<figure class="tm-person">
							<img src="${pageContext.request.contextPath}/resources/img/about-02.jpg" alt="Image" class="img-fluid tm-person-img" />
							<figcaption class="tm-person-description">
					...
					<article class="col-lg-6">
						<figure class="tm-person">
							<img src="${pageContext.request.contextPath}/resources/img/about-03.jpg" alt="Image" class="img-fluid tm-person-img" />
							<figcaption class="tm-person-description">
					...
					<article class="col-lg-6">
						<figure class="tm-person">
							<img src="${pageContext.request.contextPath}/resources/img/about-04.jpg" alt="Image" class="img-fluid tm-person-img" />
							<figcaption class="tm-person-description">
				...
				<div class="row">
					<div class="col-12">
						<div class="placeholder-2">
							<div class="parallax-window-2" data-parallax="scroll" data-image-src="${pageContext.request.contextPath}/resources/img/about-05.jpg"></div>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-lg-4">
						<div class="tm-feature">
							...
							<a href="${pageContext.request.contextPath}/" class="tm-btn tm-btn-primary">Read More</a>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="tm-feature">
							...
							<a href="${pageContext.request.contextPath}/" class="tm-btn tm-btn-success">Read More</a>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="tm-feature">
							...
							<a href="${pageContext.request.contextPath}/" class="tm-btn tm-btn-danger">Read More</a>
						</div>
					</div>
				</div>
			</div>
